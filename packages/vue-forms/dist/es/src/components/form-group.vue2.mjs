import { defineComponent as V, mergeModels as v, useSlots as y, computed as s, useModel as $, openBlock as k, createElementBlock as U, normalizeClass as b, renderSlot as d, mergeProps as u, createVNode as t, createCommentVNode as m } from "vue";
import g from "./input-checkbox.vue.mjs";
import w from "./input-field.vue.mjs";
import S from "./input-select.vue.mjs";
import B from "./input-radio.vue.mjs";
import C from "./input-switch.vue.mjs";
import M from "./input-textarea.vue.mjs";
const O = /* @__PURE__ */ V({
  __name: "form-group",
  props: /* @__PURE__ */ v({
    field: {},
  ...
  setup(r) {
    const i = y(), n = s(() => Object.keys(i).length > 0), p = r, l = $(r, "modelValue"), f = s(() => [
      "text",
      "email",
      "url",
      "password",
    ...
    return (e, o) => (k(), U("div", {
      class: b([`form-group col-${e.useGrid ? "span-" : ""}${e.field.col}`, { hasSlots: n.value }])
    }, [
